<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="TypeWiseReportUI.aspx.cs" Inherits="DiagnosticSystemWeb.view.TypeWiseReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    <title>TypeWiseReportUI</title>
 </asp:Content> 
<asp:Content ID="typeWiseReportContent" ContentPlaceHolderID="MainContent" runat="server">
    <form class="form-horizontal" id="TypeWiseReportUIForm" runat="server">
       
        <h3 class="title text-center">Type Wise Report</h3>
        ...
        <div class="row">
            <div class="col-lg-12">
                <asp:Button ID="pdfButton" runat="server" cssClass="btn btn-primary btn-custom right" Text="PDF" OnClick="pdfButton_OnClick" />
